    ...
    <div class="shadow-lg card blur">
      <div class="pt-3 pb-0 bg-transparent card-header">
        <div class="float-start">
          <h5 class="mt-3 mb-0">Quotaions Deals</h5>
      ...
      <div class="pt-0 card-body pt-sm-3">
        ...
        <a href="#" class="switch-trigger background-color">
          <div
            ...
            :class="this.$store.state.settings.isRTL ? 'text-end' : ' text-start'"
          >
            <span
        ...
        <div class="form-check form-switch ps-0">
          <input
            ...
            :class="this.$store.state.settings.isRTL ? 'float-end  me-auto' : ' ms-auto'"
            type="checkbox"
            id="navbarFixed"
            :checked="this.$store.state.settings.isNavFixed"
...
export default {
  ...
  methods: {
    ...
    sidebarColor(color = "success") {
      ...
      this.$store.state.settings.mcolor = `card-background-mask-${color}`;
    },
    ...
    setNavbarFixed() {
      if (this.$route.name !== "Profile") {
        this.$store.state.settings.isNavFixed = !this.$store.state.settings.isNavFixed;
      }
    },
  ...
  computed: {
    ifTransparent() {
      return this.$store.state.settings.isTransparent;
    },
    sidenavResponsive() {
