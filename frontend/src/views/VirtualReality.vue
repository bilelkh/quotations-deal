<template>
  <div>
    <navbar
      ...
      :class="
        this.$store.state.settings.isNavFixed ? this.$store.state.settings.navbarFixed_class : ''
      "
    />
  </div>
  <div
...
export default {
  ...
  beforeMount() {
    ...
    this.$store.state.settings.isTransparent = "bg-white";
  },
  beforeUnmount() {
    ...
    if (this.$store.state.settings.isPinned === false) {
      const sidenav_show = document.querySelector(".g-sidenav-show");
      sidenav_show.classList.remove("g-sidenav-hidden");
      sidenav_show.classList.add("g-sidenav-pinned");
      this.$store.state.settings.isPinned = true;
    }
